...
urlpatterns = [
    ...
    path('exercise_detail/<int:pk>/', views.ExerciseDetailView.as_view(), name='exercise_detail'),
    path('session_history/', views.SessionHistoryView.as_view(), name='session_history'),
